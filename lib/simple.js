...
END:VCARD
    ...
    conn.sendButton = async (jid, contentText, footer, buffer, buttons, quoted, options) => {
       ...
       conn.sendBut = async(jid, content, footer, button1, row1, quoted, options) => {
	  const buttons = [
...
return await conn.sendMessage(jid, buttonMessage, { quoted,
   ...
   conn.send2But = async(jid, content, footer, button1, row1, button2, row2, quoted, options) => {
	  const buttons = [
	   { buttonId: row1, buttonText: { displayText: button1 }, type: 1 },
...
return await conn.sendMessage(jid, buttonMessage, { quoted,
   ...
   conn.send3But = async(jid, content, footer,button1, row1, button2, row2, button3, row3, quoted, options) => {
	  const buttons = [
	  { buttonId: row1, buttonText: { displayText: button1 }, type: 1 },
          { buttonId: row2, buttonText: { displayText: button2 }, type: 1 },
...
conn.sendButtonImg = async(jid, buffer, content, footer, button1, row1, quoted, options) => {
	  const buttons = [
	  {buttonId: row1, buttonText: {displayText: button1}, type: 1}
	  ]
const buttonMessage = {
...
return await conn.sendMessage(jid, buttonMessage, { quoted,
   ...
   conn.send2ButtonImg = async(jid, content, footer, button1, row1, button2, row2, quoted, options) => {
	  const buttons = [
	   { buttonId: row1, buttonText: { displayText: button1 }, type: 1 },
          { buttonId: row2, buttonText: { displayText: button2 }, type: 1 }
	  ]
...
return await conn.sendMessage(jid, buttonMessage, { quoted,
   ...
   conn.send3ButtonImg = async(jid, content, footer,button1, row1, button2, row2, button3, row3, quoted, options) => {
	  const buttons = [
	  { buttonId: row1, buttonText: { displayText: button1 }, type: 1 },
          { buttonId: row2, buttonText: { displayText: button2 }, type: 1 },
          { buttonId: row3, buttonText: { displayText: button3 }, type: 1 }
...
return await conn.sendMessage(jid, buttonMessage, { quoted,
    ...
    */
	...
	conn.sendHBut = async (jid, content, distek, link, discall, number, retek, id,quoted) => {
		let template = generateWAMessageFromContent(jid, proto.Message.fromObject({
			         templateMessage: {
             hydratedTemplate: {
                 hydratedContentText: content,
